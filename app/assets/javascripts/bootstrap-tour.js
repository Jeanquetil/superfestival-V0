  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title text-center"></h3> <div class="popover-content text-center"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-std" data-role="prev">&laquo; Prev</button> <button class="btn btn-std" id="no-margin" data-role="next">Next &raquo;</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div></div> <a href="" id="close" data-role="end"><i class="fa fa-times" aria-hidden="true"></i></a></div>',
         // <a href="" data-role="end"><i class="fa fa-times" aria-hidden="true"></i></a>
